...
export const marketColumns = [
    {
        title: (
            <span className='flex items-center justify-start'>Date</span>
        ),
        dataIndex: 'date',
        key: 'date',
        render: (value: RowObject['date']) => (
            <span className='w-full text-primary flex items-center justify-start'>{moment(value).format('YYYY/MM/DD HH:mm')}</span>
        ),
    },
    {
        title: 'Activity',
    ...
    {
        title: (
            <span className='flex items-center justify-center'>Rewards</span>
        ),
        dataIndex: 'rewards',
        key: 'rewards',
        render: (value: any) => {
            return <span className='w-full text-primary flex items-center justify-center'>{value} Points</span>
        }
    },
]
...
export const rewardCenterColumns = [
    {
        ...
        key: 'rewards',
        render: (value: any) => {
            return <span className='w-full text-primary flex items-center justify-start'>+ {value} Points</span>
        }
    },
    {
        title: 'reward',
    ...
    },
    {
        ...
        render: (value: any) => {
            return <div className='w-full flex justify-end'>
                <span className='bg-[#0D0D0D] text-thirdary py-[11px] px-[22px] rounded-[30px] curosr-pointer button-hover' onClick={() => handleRedeem(value)}>Redeem</span>
            </div>
        }
    },
]
