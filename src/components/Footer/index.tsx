  ...
  return (
    <footer className="bg-primary text-thirdary w-full py-4 px-6 sm:px-12 flex flex-col sm:flex-row items-start justify-between">
      <div className="mb-4 sm:mb-0 text-left">
        <p className="text-[1.2rem] sm:text-[1.1rem] font-[600] mb-2 sm:mb-[14px]">
          {t("Docs")}
        </p>
        <p
          className="text-xs sm:text-desc text-[#999999] cursor-pointer"
      ...
      <div className="flex flex-col items-start">
        <p className="text-base sm:text-coinMd font-600 mb-2 sm:mb-[14px]">
          {t("community")}
        </p>
        <div className="flex flex-wrap justify-start gap-2 sm:gap-4">
          <Link
            href="https://x.com/ShambhalaJP?t=dw2EdYr8sUyiHygB0zY-dw&s=09"
            passHref
          >
            <Image
              src={"/x.svg"}
          ...
          <Link
            href="https://www.instagram.com/shambhaladefi?igsh=MThpdGdmYzZuOXgxYQ=="
            passHref
          >
            <Image
              src={"/instagram.svg"}
